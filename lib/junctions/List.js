...
var excludeDuplicate = function excludeDuplicate(array) {
  return array.filter(function (a, index, self) {
    return self.findIndex(function (b) {
      return (0, _Relation.equal)(a)(b);
    }) === index;
  });
};
...
var removeItem = function removeItem(item) {
  return function (array) {
    return array.filter(function (i) {
      return !(0, _Relation.equal)(item)(i);
    });
  };
};
...
exports.excludeDuplicate = excludeDuplicate;
