...
export { default as addSlashes } from './addSlashes'
...
export { default as getLast } from './getLast'
export { default as getFirst } from './getFirst'
...
export { default as flatFilter } from './flatFilter'
