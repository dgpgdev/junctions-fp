...
describe('[ Object ]', function () {
  ...
  it('should test extract', () => {
    const item = { name: 'Gandalf', age: 'unknow', type: 'magical', weapon: undefined }
    expect(extract('type', item)).toEqual({ type: 'magical' })
    expect(extract([ 'type', 'age', 'weapon' ], item)).toEqual({ age: 'unknow', type: 'magical', weapon: undefined })
    expect(item).toEqual({ name: 'Gandalf', age: 'unknow', type: 'magical', weapon: undefined })
  })
  it('should test has', () => {
